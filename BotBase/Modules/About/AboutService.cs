...
public class AboutService
{
    ...
    public AboutService(BotConfigBase botConfig, OverrideTrackerService overrideService)
    {
    ...
    public async Task<MessageContents> GetMessageContents(KeyValuePair<string, string>[] placeholders, ulong userId)
    {
        ...
        {
            components.WithButton("Toggle override", BaseModulePrefixes.ABOUT_OVERRIDE_TOGGLE,
